...
/** \brief listara a las personas bajo su nombre.
 *
 * \param lista[] sera la estructura de las personas a mostrar.
 * \param tamLista tamaño del array de personas con la lista.
 *
 */
 ...
 * \return sera el primer indice disponible y -1 en caso de no haberlugares libres
 */
